...
class User(BaseModel):
    ...
    email: str = Field(
        ..., description="The user's email address", example="john.doe@example.com"
    )
    ...
    age: Optional[int] = Field(
        ...
        ge=0,
        le=120,
        description="The user's age, must be between 0 and 120",
        example=30,
    )
    is_active: bool = Field(
        default=True, description="Is the user currently active?", example=True
    )
